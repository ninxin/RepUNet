...
if __name__ == '__main__':
    ...
    parser.add_argument("-wp", "--wetght_path", default=f"", type=str,
                        help='the path of wetght.pt')  # pretrained_weights/DRIVE/checkpoint-epoch40.pth
