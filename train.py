...
def main(CFG, data_path, batch_size, with_val=False):
    ...
    if with_val:
        ...
        val_loader = DataLoader(
            val_dataset, batch_size, shuffle=False, num_workers=16, pin_memory=True, drop_last=False)        # 16
    else:
        train_dataset = vessel_dataset(data_path, mode="training")
    train_loader = DataLoader(
        train_dataset, batch_size, shuffle=True, num_workers=16, pin_memory=True, drop_last=True)        # 16
...
if __name__ == '__main__':
    ...
    parser.add_argument('-dp', '--dataset_path', default="", type=str,
                        help='the path of dataset')     # \paper/home/lwt/data_pro/vessel/DRIVE
    parser.add_argument('-bs', '--batch_size', default=128,
                        help='batch_size for trianing and validation')          # 512
